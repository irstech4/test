...
mongoose.connection.once('open', () => {
  const store = new MongoStore({ mongoose: mongoose, session: 'my-session' });
      ...
      if (message.from !== 'status@broadcast') {
        ...
        switch (currentState) {
          ...
          case STATES.QUERY_HANDLING:
            // Handle user query (more complex logic can be added here)
...
//   // Example usage: Initialize multiple clients
